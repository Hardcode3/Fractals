...
public:
	...
	void compute_mandelbrot_async(std::size_t max_iteration, std::complex<long double> z0 = std::complex<long double>(0, 0), std::size_t thread_count = 20, RGBAPixel::ColorMap colormap = RGBAPixel::BLACKNWHITE_CIRCULAR);
...
private:
	...
	long double step_real_, step_im_;
